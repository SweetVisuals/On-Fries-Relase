...
export const AboutPage = () => {
  ...
  const getDisplayHours = () => {
    if (!settings?.opening_times) {
      return [
        { days: 'Wed - Thu', hours: '12:00 PM - 6:00 PM' },
  ...
  const faqs = [
    ...
    {
      question: "Where can I see the alergens of your food?",
      answer: "Alergens can be found on the menu page shown for each individual item, please ask staff for any further questions."
    },
    {
      question: "What type of steak do you sell?",
      answer: "We sell premium tri-tip sirloin steaks, we recommend using our signature sauces along side for the whole experience."
    },
    {
      question: "Do you do delivery?",
      answer: "We currently deliver using UberEats, if you live in a near enough radius then we can offer delivery."
    }
  ];
          ...
          <div className="h-48 md:h-64 w-full bg-zinc-800 relative cursor-pointer order-first md:order-none" onClick={() => window.open('https://maps.google.com/maps?q=Clock%20Tower%2C%20Kings%20Shade%20Walk%2C%20Epsom%20KT19%208EB', '_blank')}>
            ...
            <div className="hidden md:block absolute bottom-4 left-4 right-4 bg-zinc-900/90 backdrop-blur border border-zinc-700 p-4 rounded-xl">
              ...
              <div className="flex gap-4 mt-3">
                ...
                <a href="#" className="text-xs font-bold text-brand-yellow flex items-center gap-1 hover:underline"><Mail className="w-3 h-3" /> contact@onfries.co.uk</a>
              </div>
            </div>
          </div>
