        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] p-4 animate-fade-in">
          ...
          <div className="w-full max-w-md bg-zinc-900 border border-zinc-800 rounded-2xl p-8 shadow-2xl">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-zinc-800 hover:bg-zinc-700 text-white font-medium py-3 rounded-xl transition-colors mb-4"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-red-600/10 hover:bg-red-600/20 text-red-500 border border-red-600/20 font-medium py-3 rounded-xl transition-colors"
            >
              <ShieldCheck className="w-4 h-4" /> Delete Account
            </button>
          </div>
        </div>
      </CustomerLayout>
