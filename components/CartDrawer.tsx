              ...
              {!showPaymentForm ? (
                <>
                  <div className="flex justify-between items-end mb-2">
                    <span className="text-zinc-500 text-sm">Delivery Service:</span>
                    <span className="text-zinc-400 font-medium">Free</span>
                  </div>

                  <div className="flex justify-between items-end mb-6 pt-2 border-t border-zinc-800">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="mb-4 space-y-3">
                      <div>
                        <label className="text-zinc-400 text-xs font-bold uppercase tracking-wider mb-1.5 block">Special Instructions / Allergies</label>
                        <textarea
                          value={notes}
                          onChange={(e) => setNotes(e.target.value)}
                          placeholder="e.g. No onions, sauce on side..."
                          className="w-full bg-zinc-950 border border-zinc-800 rounded-xl p-3 text-white text-sm focus:outline-none focus:border-brand-yellow resize-none h-20"
                        />
                      </div>
                      <p className="text-zinc-500 text-xs italic">
                        <span className="text-brand-yellow font-bold">Note:</span> Always contact the restaurant directly if you have a severe allergy.
                      </p>
                    </div>
                    {!user ? (
                      <Link
