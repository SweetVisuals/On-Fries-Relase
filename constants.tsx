...
export const MOCK_MENU: MenuItem[] = [
  {
    ...
    description: '2 Premium quality steaks with our signature fries and special seasoning.',
    price: 20.00,
    category: 'Main',
    image: '/images/deluxesteakfriesv2.png',
    image_url: '/images/deluxesteakfriesv2.png',
    is_available: true,
    is_visible: true,
    allergens: [],
    time: '25 min',
  ...
  },
  {
    ...
    price: 12.00,
    category: 'Main',
    image: '/images/steakfriesv2.png',
    image_url: '/images/steakfriesv2.png',
    is_available: true,
    is_visible: true,
    allergens: [],
    time: '20 min',
  ...
  },
  {
    ...
    price: 10.00,
    category: 'Main',
    image: '/images/steakonlyv2.png',
    image_url: '/images/steakonlyv2.png',
    is_available: true,
    is_visible: true,
    allergens: [],
    time: '15 min',
  ...
  },
  {
    ...
    price: 4.00,
    category: 'Sides',
    image: '/images/friesonlyv2.png',
    image_url: '/images/friesonlyv2.png',
    is_available: true,
    is_visible: true,
    allergens: [],
    time: '5 min',
...
// Addon information - allergens and dietary info
export const ADDON_INFO: Record<string, { allergens: string[], dietary: string[] }> = {
  'Green Sauce': {
